...
class Queue<T> {
  ...
  public Queue(int size) {
    this.maxSize = size;
    // The only way we can put objects into the array is through the 
    // method enq, which itself already gurantees that the object is
    // of same type T, there is no getter methods here that allows
    // users to get and modify the Queue to include any type other than T
